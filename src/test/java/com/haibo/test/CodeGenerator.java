...
public class CodeGenerator {
	 ...
	 */
	private String domainPackage = "com.haibo.test.model.domain";
	
	/**
	 * the project service package
	 */
	private String servicePackage = "com.haibo.test.service";
	
	/**
	 * the project mapper package
	 */
	private String mapperPackage = "com.haibo.test.mapper";
