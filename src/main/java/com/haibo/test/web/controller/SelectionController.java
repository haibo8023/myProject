...
public class SelectionController {
    ...
    private static String infoUrl = "https://www.jiyou-tech.com/2018/287/php/get_rank.php";
    ...
    public JsonResponse getInfo() {
        ...
        Map<String, String> createMap = new HashMap<String, String>();
        createMap.put("customer", customer);
        String httpOrgCreateTestRtn = httpClientUtil.doPost(infoUrl, createMap, charset);
        JSONObject jsonObject = JSONObject.parseObject(httpOrgCreateTestRtn);
        return JsonResponse.success(jsonObject.toJSONString());
    }
}
