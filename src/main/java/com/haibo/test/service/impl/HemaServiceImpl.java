...
public class HemaServiceImpl {
    ...
    public void testMain(String cookie1,String cookie2,String cookie3) throws Exception {
        ...
        try {
            for(String activityId:list){
                ...
                //String result3 = HttpClientUtil.doPost(url, createMap, userAgent1, cookie3);
...
//                if (null != jsStr3) {
//                    System.out.println("333333----第3个号"+jsStr3.toJSONString());
//                }
            }
        } catch (Exception e) {
            e.printStackTrace();
